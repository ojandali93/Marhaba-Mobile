...
const PasswordModalContent = ({ password, setPassword, newPassword, setNewPassword, verifyPassword, setVerifyPassword, setActiveModal }: PasswordModalContentProps) => {
  return (
    <View>
     <Text style={tailwind`text-lg font-semibold mb-2 text-center`}>Change Password</Text>
          ...
          <View style={tailwind`w-full mt-2`}>
            <Text style={tailwind`text-sm font-semibold`}>Verify New Password:</Text>
            <TextInput
