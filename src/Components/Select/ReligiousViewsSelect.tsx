    ...
    <>
      ...
      <TouchableOpacity
        ...
        <Text style={tailwind`text-base text-gray-800`}>
          {selected || 'Select Religious Views'}
        </Text>
      </TouchableOpacity>
...
export default ReligiousViewsSelect;
