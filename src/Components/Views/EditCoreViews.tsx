...
const EditCoreViews = () => {
  ...
  const [family, setFamily] = useState(profile?.Core[0].family || '');
  const [faith, setFaith] = useState(profile?.Core[0].faith || '');
  const [ambition, setAmbition] = useState(profile?.Core[0].ambition || '');
  const [career, setCareer] = useState(profile?.Core[0].career || '');
  const [honest, setHonest] = useState(profile?.Core[0].honest || '');
  const [transparency, setTransparency] = useState(
    profile?.Core[0].transparent || '',
  );
  const [trust, setTrust] = useState(profile?.Core[0].trust || '');
  const [politics, setPolitics] = useState(profile?.Core[0].politics || '');
  const [social, setSocial] = useState(profile?.Core[0].social || '');
  ...
  const loadCoreViews = () => {
    ...
    setCareer(profile?.Core[0].career);
    setHonest(profile?.Core[0].honest);
    setTransparency(profile?.Core[0].transparent);
    setTrust(profile?.Core[0].trust);
    setPolitics(profile?.Core[0].politics);
    setSocial(profile?.Core[0].social);
  };
