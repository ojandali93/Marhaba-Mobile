...
const ContactUsView = ({ updateTab }: MenuViewProps) => {
  ...
  return (
    <View style={tailwind`flex-1`}>
      ...
      {/* User Info */}
      <Text style={tailwind`text-base text-center text-gray-700 mb-4`}>
  We appreciate you reaching out to us. Whether you have feedback, a question, or need help with your account, we're here to support you. Please allow up to 48 hours for a member of our team to respond.
</Text>
      {/* Message Input */}
